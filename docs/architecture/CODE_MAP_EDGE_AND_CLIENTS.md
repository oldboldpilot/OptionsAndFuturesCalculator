...
- **The Numeric Contract**:
  - `string`: Represents exact fixed-point `sensen::BigDecimal` (`__int128` scaled by 1e18, 18 decimal places) (`clients/mortgagefv/proto/finance.proto:35-37`; `clients/mortgagefv/README.md:200-205`). Used for all monetary values, principal, amortization rows, and rates on standard calculators (`PaymentRequest`, `DecimalResponse`, `AmortizationRequest`, `HelocRequest`, `RentalRoiRequest`, etc.) (`clients/mortgagefv/README.md:218-228`).
